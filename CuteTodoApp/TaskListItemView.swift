...
struct TaskListItemView: View {
    ...
    var body: some View {
        ...
        .frame(maxWidth: .infinity, maxHeight: 160, alignment: .bottom).matchedGeometryEffect(id: "Position", in: namespace)
...
struct TaskListItemView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        TaskListItemView(task: taskModel.tasks[0], namespace: namespace, show: .constant(true))
